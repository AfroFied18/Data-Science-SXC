...
author: "Apratim Dey Tapadar, 751"
date: "2026-02-05"
...
plot(x_range, y_population, type = "l", lwd = 3)
...
for(i in 1:5){
  ...
  abline(lin_reg, col = i)
}


# Step 5:

Coef_table = as.data.frame(beta_hat,
                           col.names = c("beta_0_hat","beta_1_hat"))
Coef_table
